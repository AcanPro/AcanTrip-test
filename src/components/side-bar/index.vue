<template>
	<div v-if="sideDatas.length" class="side-bar">
		...
		<div class="content">
			<slot name="content" :items="sideDatas[currentSideActive].items"
				:subGroups="sideDatas[currentSideActive].subGroups">
				<template v-if="sideDatas[currentSideActive].items"
					v-for="(addrInfo, index) in sideDatas[currentSideActive].items" :key="index">
					<div :class="['list-item', addrInfo.isSelect ? 'active' : '']"
					...
					<div class="sub-side-panel">
						<div class="sub-side-bar">
							<van-sidebar v-model="currentSubSideActive" @change="onSubSideMenuChange">
								<template v-for="(group, indy) in sideDatas[currentSideActive]
									.subGroups" :key="indy">
						...
						<div class="sub-content">
							...
							<template v-for="(addr, indz) in getSubSideItems" :key="indz">
								<div :class="['list-item', addr.isSelect ? 'active' : '']" @click="handleSubItemClick(indz)">
