<template>
	<div class="house">
		...
		<div class="tags">
			<template v-for="(item, index) in topModule?.houseTags">
		...
		<div class="extra comment">
			...
			<div class="right">
				<span class="count">{{ topModule?.commentBrief?.totalCount + "条评论 >" }}</span>
			</div>
		</div>
...
const topModule = computed(() => detailStore.mainPart?.topModule)
</script>
