<template>
	<div class="search">
		...
		<!-- 点击搜索显示搜索面板 -->
		<search-panel v-if="showSearchPanel" :searchPanelDatas="guessulike?.groups" @cancel="handleCancel"
			@search="handleSearch" @tag-click="handleTagClick" @result-item-click="handleResultItemClick">
		</search-panel>
	</div>
</template>
